<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPanel.Master" AutoEventWireup="true" CodeBehind="setupproc.aspx.cs" Inherits="BIGSHOPE.admin.setupproc" %>
    ...
    <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <h1>Setup Processor<small></small></h1>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-success" Text="Save" OnClick="btnAdd_Click" />
