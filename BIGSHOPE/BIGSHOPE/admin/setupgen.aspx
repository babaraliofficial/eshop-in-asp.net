<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminPanel.Master" AutoEventWireup="true" CodeBehind="setupgen.aspx.cs" Inherits="BIGSHOPE.admin.setupgen" %>
    ...
    <div id="page-wrapper">
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <h1>Setup Generation<small></small></h1>
